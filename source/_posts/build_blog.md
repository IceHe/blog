...
1. #### Theme 主题
	...
	**通常还会提供许多功能模块的配套支持！
	一般包括但不限于：评论、分享、RSS订阅、联系方式、百度/谷歌的统计分析、标签云。**
...
6. #### Domain Name 域名
	...
	具体配置过程可参考：[购买域名、设置DNS](http://zipperary.com/2013/05/27/domain-name-and-dns/)
	<br/>
...
7. #### Sitemap 站点地图 & RSS 订阅
	...
	具体配置过程可参考：[hexo系列教程：（五）hexo博客的优化技巧续](http://zipperary.com/2013/06/02/hexo-guide-5/)（推荐结合以下内容阅读）
	<br/>
...
8. #### Widget 闲杂模块
	...
	其它的模块，如：
	[微博秀](http://jssdk.sinaapp.com/widget/weiboshow.php)
	<br/>
