...
- Encrypt / Decrypt :&nbsp; [Hash](http://tool.oschina.net/encrypt?type=2) ,&nbsp; [Base64](http://tool.oschina.net/encrypt?type=3), [Base64/图片](http://tool.oschina.net/encrypt?type=4) ,&nbsp; [AES & etc](http://tool.oschina.net/encrypt) - 加密 / 解密

- QrCode :&nbsp; [Generate](http://tool.oschina.net/qr) / [Decode](http://tool.oschina.net/qr?type=2) - 二维码 生成 / 解析
...
- [HTML4](http://www.cheatography.com/davechild/cheat-sheets/html4/) / [CSS2](http://www.cheatography.com/davechild/cheat-sheets/css2/) / [CSS 之各种居中](https://segmentfault.com/a/1190000004260458)

- [\*ML Char Entity Ref](http://www.elizabethcastro.com/html/extras/entities.html) / [Ref 2](http://www.cheatography.com/davechild/cheat-sheets/html-character-entities/) - [字符实体引用](http://tool.oschina.net/commons?type=2)

- [JavaScript Ref (img)](http://javascript-reference.info/) / [jQuery Docs Refs](http://tool.oschina.net/apidocs/apidoc?api=jquery) / [jQuery](http://www.cheatography.com/i3quest/cheat-sheets/jquery/)
...
- [TCP & UDP Port Numbers](https://en.wikipedia.org/wiki/List_of_TCP_and_UDP_port_numbers#Well-known_ports) - [端口号](http://tool.oschina.net/commons?type=7)
...
- [常用颜色对照表](http://tool.oschina.net/commons?type=3)、 [网页设计常用色彩搭配表]((http://tool.c7sky.com/webcolor/)

<!--[Cheat-Sheets.org](http://www.cheat-sheets.org/) As same as OverAPI, but it have less cheat sheets than that. / [Dynamic Cheat Sheets](http://www.cheatography.com/) Another-->
...
- [PHP.net](http://php.net/) / [Python.org](https://www.python.org) / [Vim.org](http://www.vim.org) / [Z shell](http://zsh.sourceforge.net/)

- [PHP Value Comparison](http://www.blueshoes.org/en/developer/php_cheat_sheet) PHP 变量比较结果参考

- [Awesome PHP](https://github.com/ziadoz/awesome-php) - 译文：[PHP 资源列表](http://blog.jobbole.com/82908/)

- [Awesome Python](https://python.libhunt.com/) - List of frameworks, packages, software and resources

- [ASCII Table](http://www.asciitable.com/) 码表

- [SQL](http://www.cheat-sheets.org/sites/sql.su/) in one page

- [Network](http://www.cheatography.com/monsieur-h/cheat-sheets/network-lesson/) <sup>Cheat Sheet</sup> <sup>_todo_</sup>

- [Operating Systems](http://www.cheatography.com/makahoshi1/cheat-sheets/operating-systems/) <sup>Cheat Sheet</sup> <sup>_todo_</sup>

- [C](http://www.cheatography.com/pmg/cheat-sheets/c/) / [Object Oriented Java](http://www.cheatography.com/tarinya/cheat-sheets/oo-java/) / __[OO Design](http://www.cheatography.com/david/cheat-sheets/object-oriented-design/)__ <sup>Cheat Sheet</sup>
...
- [The 37 Best Websites To Learn Something New](https://entrepreneurs.maqtoob.com/the-37-best-websites-to-learn-something-new-895e2cb0cad4#.ga9ftrdka) <sup>_todo_</sup>
