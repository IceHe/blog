...
- __Principles 原则__
    ...
    - 「常用」的工具才值得折腾，使用机会少的工具就凑合着用吧，不要荒废大好时光。
    - 适合自己的工具，才是最好的工具。所以可以参考本文，进行尝试。
- __References 部分参考__
    - [利器 - 创造者和他们的工具](http://liqi.io/) 以及使用的方式和原则。
    - [少数派](http://sspai.com/) - 高质量 App 推荐媒体，关于 iOS、Mac、硬件。
    - [MacTips](http://zhuanlan.zhihu.com/MacTips) - Mac 使用经验和技巧。
- The item with the supscript <sup>__Best__</sup>&nbsp; implies it is `one of the best` and so on.
- 删除了一些原来有记录的 Apps，虽然我长时间用过它们，但还是觉得它们没有提及的价值（它们连弃用的理由也没必要说明）。
...
- Usual
    - [Evernote (Premium)](https://www.yinxiang.com/) <sup>Favorite</sup>
        云笔记，第二大脑（知识管理）。
    ...
    - [2Do](https://www.2doapp.com/) <sup>Favorite</sup>
        GTD 类事务管理。
        - 功能齐全、好用，用法可简可繁。快捷键完备，深得我这个键盘党的喜爱！推荐使用 iCloud Reminders 的 CalDAV 同步方式。
        - 一开始用 [Doit.im](http://doit.im/cn/) 入门 GTD，虽然它的 Web 端的操作很极致高效，但客户端做得不尽人意。后来发现自己的生活很规律，无需复杂的管理，于是只用 Apple 自带的 Calendar。考虑过团队协作类的 App，如 [Worktile](https://worktile.com/)，但团队协作的功能都用不上，个人管理的功能又不够简便易用。后来又用免费版 [Wunderlist](https://www.wunderlist.com/zh/) 了，任务管理的操作远不如 Web 端的 Doit.im 极致，但客户端做得不错，勉强满足个人需求。现在用 2Do。
    - [1Password](https://agilebits.com/onepassword)
        密码管理。一（两）个密码管理所有其它密码，可自动填写网站的帐号和密码表单进行登录。
        - 以前一直用不惯，觉得用浏览器自带的自动登录和 iCloud 的 KeyChain Access 来记录管理帐号和密码足矣。工作之后经济独立了，更加注意保护自己的个人隐私和财产安全了，要管理相关的虚拟信息多而杂乱，还有部分需要额外的加密。所以不得不开始使用密码管理工具。
        - Other choices :
            - [__Dashlane__](https://www.dashlane.com/) : Excellent but expensive!
            - [__LastPass__](https://lastpass.com/) : Able to use for free.
    - 双拼输入方案！<sup>Favorite</sup>
        高效，易学！比五笔容易掌握得多，习得的性价比高，赶紧走出你的舒适区来试试双拼吧！
...
- Web
    - [Shawdowsocks](https://portal.shadowsocks.com/) <sup>Ladder</sup>
        - 首选的 PC 番羽土啬方案：
            ...
            如 FireFox 的 [FoxyProxy](https://getfoxyproxy.org/)，Chrome 的 [SwitchyOmega](https://chrome.google.com/webstore/detail/proxy-switchyomega/padekgcemlokbadohgkifijomclgjgif?hl=en)。
    ...
    - [Chrome](https://www.google.com/chrome/) <sup>Most Usual</sup>
        用 Inspect Element 等 Develop Tools 做 Web 的开发、调试（远胜 FireFox 的半吊子 Firebug ）。
    - [Firefox](http://www.firefox.com.cn/) <sup>Favorite</sup>
...
- Editor
    ...
    - [~~spf13-vim~~](http://vim.spf13.com/) <sup>Essential</sup>
        ...
        （根本用不上其中的很多功能，而且高配的 [MBP](#Smart) 用起来竟然卡！其实用熟 Vim 后，根据个人习惯在 `.vimrc` 写好的基本设置，就够用了。）
...
- Shell
    - [Zsh](http://zsh.sourceforge.net/) <sup>Powerful</sup>
        ...
        - [Fish](https://fishshell.com/) (a shell for the 90s 😂 ) 虽然很好，但存在兼容性问题，有些 Bash 的指令需要改写才能运行在 Fish 上。
...
- Package
    ...
    - [~~Homebrew Cask~~](http://caskroom.io/) <sup>Great</sup>
        ...
        - 这样就可以用脚本来安装、更新 macOS 的 Apps 了。
        （用的机会少，其实不必安装。）
    - [~~dotfiles~~](https://dotfiles.github.io/)
        各路大神的 dotfiles 配置。
        （ [dotfiles 是什么？](http://www.jianshu.com/p/7UJapk)其实并不需要那么多工具包，有需要再折腾才是正道。）
    - [YADR](http://skwp.github.io/dotfiles/)
        Yet Another Dotfile Repo，一个便捷的命令行配置方案，包括 Vim、Zsh、tmux、Git、RubyGems 以及 Alias 等各种配置。新手可以一试。
...
- Develop
    ...
    - [~~Dash~~](https://kapeli.com/dash) <sup>To the point</sup>
        ...
        （我还是习惯去官网看文档，毕竟在浏览器可以用我的 Vim 式快捷键操作。）
...
- Editors
    ...
    - [~~VS Code~~](https://code.visualstudio.com/) <sup>潜力股</sup>
        简洁好用，只是 Vim 插件的体验不如 Atom，所以我放弃了。
    - [~~Typora~~](http://www.typora.io) <sup>Elegant</sup>
        Markdown 编辑器，所见即所得。国人制作，完全免费，支持 Mac、Windows！
        （我很少需要预览 Markdown 内容的显示效果，所以用一般编辑器即可。）
...
- Web
    ...
    - [~~Transmit~~](https://panic.com/transmit/)
        FTP 的 GUI 工具。
        （rsync 命令比 FTP 的效率高多了，用法也丰富。一般情况下用 netcat 命令传输文件也够用了。）
...
- Others
    - [Adobe Acrobat Reader DC](https://get.adobe.com/cn/reader/)
        ...
        - 但要在商务等正式场景下的 PDF 文件有高端用法，这是还是得 Adobe 家的软件来处理，例如签证申请文件、合同、保密文件等。
    ...
    - [~~Parallel Desktop~~](http://www.parallels.com/landingpage/pd/general/?src=r&pd11) <sup>Best</sup>
        ...
        （因为我不需要用 Windows 平台独占的那些软件，所以几乎用不上本软件。）
...
- Shortcuts & Keyboard
    ...
    - [Karabiner](https://pqrs.org/osx/karabiner/index.html.en) <sup>Geek, Best</sup>
        ...
        （噩耗：macOS Sierra (10.12) 中关于键盘控制的代码大改，所以这代及以后的 macOS 就不能使用 Karabiner 了。除非 Karabiner 作者进行重大更新，然而工作量颇大，可用的新版本遥遥无期……）
...
- __不常用 / 鸡肋__
    放在这里的有一些公认很好的 Apps，但我觉得它们不常用甚至鸡肋，且看我的理由。
...
- Efficiency
    - [Alfred](https://www.alfredapp.com/) <sup>键盘党的神兵利器</sup>
        ...
        - __我更喜欢敲快捷键「一步到位」告诉 Mac 要做的事！__ 做好脚本或录制好一系列操作，主要用 AppleScript、Keyboard Maestro 和 Automator 等，然后用快捷键激它们，真正常用的组合操作并不会很多。
    ...
    - [iHosts](https://itunes.apple.com/us/app/ihosts/id1102004240?mt=12)
        ...
        - 可惜通常情况下，hosts 并不需要复杂的管理，还有很多其它手段达到同样的目的。
        不如直接在命令行加一个简短的 alias 用于直接打开修改 hosts 文件，这样比较省事。
    ...
    - [~~Shortcat~~](https://shortcatapp.com/) <sup>不推荐</sup>
        UI 上的 Spotlight，暂时难堪大用…… 不如快捷键来得直接。
...
- Enhance
    ...
    - [~~HyperDock~~](https://bahoom.com/hyperdock/)
        ...
        - 用处还是不大，其实只要用 HyperSwitch 去切换一个 App 各个子窗口然后直接查看就够了。
...
- Input
    ...
    - [~~TextExpander~~](https://textexpander.com/) <sup>Great</sup>
    - [~~aText~~](https://www.trankynam.com/atext/)
        使用缩写写法，来输入重复、高频的内容，按照模板生成内容，加速你的文本输入、处理速度！
        - aText 等于 TextExpander 的简化版，价格便宜多了，但功能更少、不够稳定。
        - 说实话，使用 Keyboard Maestro 就能实现我所需的基本的「缩写拓展」功能，不需要更高阶的功能。
...
- Others
    ...
    - [~~Nozio~~](http://noiz.io/) & etc
        ...
        - 可以的话，买 Bose 的 [QC 系列消噪耳机](https://www.bose.cn/zh_cn/products/headphones/noise_cancelling_headphones.html)，效果更佳。我买的是 [QC 20](https://www.bose.cn/zh_cn/products/headphones/earphones/quietcomfort-20i-acoustic-noise-cancelling-headphones.html#v=qc20_apple_black)。
            - 如需无线入耳式耳塞推荐 2017（才真正上市）的新品 [QC 30](https://www.bose.cn/zh_cn/products/headphones/earphones/quietcontrol-30.html#v=qc30_black)，外观捉急，人称狗圈。
...
- Usual
    ...
    - [~~随手记专业版~~](http://www.feidee.com/money/) <sup>One fo the best</sup>
        我用得最顺手的记账软件。弃用理由见上文。
...
- Read & Study
    ...
    - [__扇贝英语__ 系列 Apps](http://www.shanbay.com/) <sup>English</sup>
        扇贝单词、扇贝炼句、扇贝听力、扇贝读书。工具不重要，最重要还是要坚持学习。
    - [__网易公开课__](http://open.163.com/)
        国内最好的公开课平台。
...
- Others
    - [__Authy__](https://www.authy.com/)  <sup>Better Authenticator!</sup>
    ...
    - [__QQ 同步助手__](https://pim.qq.com/)
        我将其用于：英文版 iOS 的中文联系人排序、合并、去重、修改以及备份等。
    - [__欧路词典 Pro__](http://www.eudic.net/eudic/mac_dictionary.aspx)
        英语词典。可使用在线有道词典，无广告！
    - \-\-\-
    - __支付宝__ - 不得不装，用于交水电费、查快递、淘宝天猫亚马逊付款……
    - __大众点评__ - 手机剩下的唯一一个 O2O 团购软件。
    - \-\-\-
    - [~~Tencent Security~~](https://itunes.apple.com/us/app/teng-xun-shou-ji-guan-jia/id439638720?mt=8) 腾讯手机管家
        iOS 最好的来电防骚扰助手。（实际很少收到骚扰电话，所以已卸载）
    - [~~Serverauditor~~](https://serverauditor.com/) <sup>_temp_</sup>
        免费的移动 SSH 客户端。运维、服务端研发工程师们随时随地“救火”的利器。（只作为权宜之计使用）
