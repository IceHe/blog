...
categories: [whoami]
tags: [whoami]
description: Technology / Experience / Education / Leadership / etc.。
toc: true
---
...
- __TechBlog__ &nbsp; &nbsp; &nbsp; <i class="fa fa-cube"> &nbsp;</i>[icehe.me](http://icehe.me)

- __GitHub__ &nbsp; &nbsp; &nbsp; <i class="fa fa-github"> &nbsp;</i>[github.com/IceHe](https://github.com/IceHe)<br/><br/>
...
- __Language__ &nbsp; &nbsp; __<i class="fa fa-star-half-o"></i> `PHP` `C++` `Python`__ `C` `Java` `JavaScript` &nbsp; <i class="fa fa-star-o"></i> `ASM` `VB`
