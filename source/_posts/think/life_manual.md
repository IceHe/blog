...
- <u>__带着脑袋做事__</u>
    ...
    - [__多想方法__](#Methodology-方法论)

        讲究 [__方法论__](#Methodology-方法论)
...
- 心态：__实用主义__
    ...
    - __便捷 > 简洁__ （ >> 杂乱 > 极简 ）
        ...
        便捷就好，效率第一（省下精力做要事） > 强迫症：费力整理，虽悦己，但属于奢侈的快感（机会成本大）
...
The items followed are not added in the Self-Help List.
...
- __理财__
    ...
    - 消费：便捷
        ...
        - 手机支付：__Apple Pay__ > __微信__ >> 支付宝

        - 支付方式：信用卡 > 微信余额 | 余额宝 > 花呗 > 储蓄卡
    ...
    - 记账：了解开支，合理控制消费（节俭）。
        ...
        - 尽量抓大放小，只记每次公交卡、饭卡的 __充值__ 用了多少钱；而非建立一个饭卡账户、一个公交卡账户，去单独记每次坐车吃饭的钱…

    - 分散投资：投资配额 —— 微信 = 房金所 = 金蛋理财（ = U+优财？）

    - 买保险：重大疾病保险 + 癌症险 + 人身意外险？（ + 投资型险种？）

        承受不起的风险，必须防范！（一开始会觉得有点麻烦，甚至昂贵，但是习惯就好。）
...
- __工具__
    ...
    - 用 __尽可能少__（且合适、称手）的工具，去做尽可能多的工作。
...
- __微信__
    ...
    - 只删掉再也不用的对话，其它都别动！
        ...
        如果怕杂乱找不到想要的对话，那么删掉对话也是一样的，方法终归都是到联系人那一栏去找。
...
- __穿衣__
    ...
    - 可以参考乔布斯、扎克伯格，每天都穿一样的衣服，省出时间做更有意义的事。
...
- 工具控
    ...
    - 工具控的严重问题 —— 囿于工具，以致 __本末倒置、南辕北辙__：

        假如你的工作是杀手，你为了提高效率，时常磨刀刃、买更好的刀……
        慢慢地你却变成了刀具收藏家、鉴赏家，刀刃都快磨没了，却没好好地干过几票。（梗来自于播客节目《内核恐慌》）
...
- 人生目标：没想清楚
    ...
    所以要培养更强的能力，日后拥有更多的选择。
    这需要努力，所以努力就是当前的目标。

# Motivation Plan 执行力推动
