...
每当我（可能）想清楚了一些事，都会总结到这里，不时回顾。

## Goal 目标

- 人生主题：__专注__

    选中两三件事，一生沉浸其中，专注使人 __快乐__。

    - 事业、乐趣、情感

        - 事业：__服务端技术__
            <sup>其次：英语（读、听、说、写）</sup>

        - 乐趣：__博客__
            <sup>其次：运动（羽毛球、毽球）、影视（动画、电影、电视剧：日美英…杂食）、美食、旅行</sup>

        - 情感：__友情__
            <sup>其次：爱情（暂缺）、亲情。</sup>

    （选中的事可以因时而变，但是同时只能专注两三件事）
...
- 扫除障碍
    ...
    - [__刻意练习__](http://www.geekonomics10000.com/519)
        ...
        - __分块「针对性」、「大量重复」基础训练__
            ...
            - 基础训练：竞技运动的运动员，__绝大多数时间（99%）用于基础训练__，只有小部分时间才用于队内比赛。
...
- __记时__
    ...
    - 每天早上发布前一天的计划和结果反馈，并做好当天的做事计划，然后发布到我的 [微博](http://weibo.com/icedes) 上。
...
- __选择困难__：
    ...
    - 依然纠结？
        ...
        - 二、做别的要事，转移注意力。
        - 三、但是，你可能每次再碰到相关事物（Todo 项、物品），都会唤起纠结的心情，想要再次做出选择，还不如：
            事务：狠心删除 Todo 项以及有关记录，或咬咬牙把它做完了。
            物品：卖了、扔了！
...
- Todo 要有 __可度量的结果__「Measurable」
    ...
    - 「大而无当」的待办事项，极易导致拖延，然后永远都不会去做的。
        ...
        真正重要的事你会一直心心念念地想着，不必如此提醒，甚至会经常跳出来“提醒”你，总会再碰上。
...
- __摄入信息__
    ...
    - 对无穷无尽的信息的看法，和实际做法，认知失调以及对策，有点绝望，自己没救了
...
- __瞎忙__
    ...
    - 「战术上勤奋，战略上懒惰」
        ...
        - 纠结
            ...
            - 没有稳定统一一致的原则、价值取向。需要将其内化成身体和思维的习惯，达到“下意识就能作出正确决定，进行正确的行动”的地步。
